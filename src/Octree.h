...
public:
	...
	void draw(TreeNode & node, int numLevels, int level, vector<ofColor> &colorLevel);
	void draw(int numLevels, int level, vector<ofColor> &colorLevel) {
		draw(root, numLevels, level, colorLevel);
	}
